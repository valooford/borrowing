...
export type AnyOwnership<T = any> =
  | InternalConsumerOwnership<T, any, any, any>
  | BaseOwnership<T, any, any, any>
...
export type _inferTypes<T extends AnyOwnership> =
  T extends BaseOwnership<
    infer General,
    infer Captured,
    infer _State,
    infer ReleasePayload
  >
    ? {
        General: General
        Captured: Captured
...
export interface _GenericBounds<
  $General = any,
  $ReleasePayload = any,
  $Captured = any,
  $State = any,
