/**
 * original file://./../../node_modules/.pnpm/unist-util-visit@5.0.0/node_modules/unist-util-visit/lib/index.d.ts
 * changes are marked with //! comments
 */

// TODO: tsconfig.json compilerOptions.types=["retsdoc/types/unist-util-visit"]
...
declare module 'unist-util-visit' {
  ...
  > = BuildVisitorFromDescendants<InclusiveDescendant<Tree, 1>, Check> //! Max=1 to get the most accurate types
